...
function PDFTeacherPension({ data }: PDFProps) {
          ...
          <Page size="A4" style={styles.page}>
            <View style={[{ width: "100%", height: "100%", padding: "5cm 3.5cm" }]}>
              ...
              <View style={[styles.col, { marginTop: "2mm" }]}>
                <Text style={[styles.w75, styles.textBold]}>ค่ารักษาพยาบาล</Text>
                <Text style={styles.w15}></Text>
                <Text style={[styles.textEnd, styles.w15]}>{CommaNumber(0, 2)}</Text>
              </View>

              <View style={[styles.col, { marginTop: "2mm" }]}>
                <Text style={[styles.w75, styles.textBold]}>เงิน ช.ค.บ.</Text>
                <Text style={styles.w15}></Text>
                <Text style={[styles.textEnd, styles.w15]}>{CommaNumber(data.lump_sum, 2)}</Text>
              </View>

              <View style={[styles.col, { marginTop: "2mm" }]}>
                <Text style={[styles.w75, styles.textBold]}>ตบเบิก เงิน ช.ค.บ.</Text>
                <Text style={styles.w15}></Text>
                <Text style={[styles.textEnd, styles.w15]}>{CommaNumber(data.lump_sum_withdrawal, 2)}</Text>
              </View>
...
export default PDFTeacherPension