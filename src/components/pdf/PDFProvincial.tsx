...
function PDFProvincial({ data }: PDFProps) {
        ...
        >
          <Page size="A4" style={styles.page}>
            <View style={[{ width: "100%", height: "100%", padding: "5cm 3.5cm" }]}>
              ...
              <View style={styles.col}>
                <Text style={styles.w15}></Text>
                <Text style={[styles.colItem, styles.w75]}>เงินเพิ่มค่าตอบแทนพิเศษ</Text>
              ...
              <View style={styles.col}>
                <Text style={styles.w15}></Text>
                <Text style={[styles.colItem, styles.w75]}>สหกรณ์ฯ จ.กระบี่</Text>
                <Text style={[styles.colItem, styles.textEnd, styles.w15]}>{CommaNumber(0, 2)}</Text>
              </View>
              ...
              <View style={styles.col}>
                <Text style={styles.w15}></Text>
                <Text style={[styles.colItem, styles.w75]}>เงินกู้ธ.อาคารสงเคราะห์</Text>
                <Text style={[styles.colItem, styles.textEnd, styles.w15]}>{CommaNumber(0, 2)}</Text>
              </View>
              ...
              <View>
                <Text style={[{ marginTop: "5px", width: "100%" }]}>หมายเหตุ: โอนเงินเข้าบัญชีวันที่ 26 {ConvertToDateISOToThai(data.created_at)}</Text>
              </View>
            </View>
          </Page>
        </Document>
